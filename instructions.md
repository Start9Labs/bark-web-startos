...
2. StartOS shows two backup tasks:
   ...
   - an **important** task recommends adding an external target via **Configure Continuous Backups** (see [Backups](#backups) below), and clears once you do.
